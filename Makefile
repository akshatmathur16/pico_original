...
RISCV_GNU_TOOLCHAIN_INSTALL_PREFIX = ~/.local/xPacks/@xpack-dev-tools/riscv-none-embed-gcc/10.2.0-1.2.1
...
TOOLCHAIN_PREFIX = $(RISCV_GNU_TOOLCHAIN_INSTALL_PREFIX)/.content/bin/riscv-none-embed-
...
testbench.vvp: testbench.v picorv32.v picosoc/simpleuart.v hammingcode_generator.sv 
...
testbench_verilator: testbench.v picorv32.v testbench.cc
	$(VERILATOR) --cc --exe -Wno-lint -trace-fst --top-module picorv32_wrapper testbench.v picorv32.v testbench.cc \
...
firmware/firmware.hex: firmware/firmware.bin firmware/makehex.py
	$(PYTHON) firmware/makehex.py $< 776 > $@
